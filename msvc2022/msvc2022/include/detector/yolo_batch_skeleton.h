...
#ifndef YOLO_BATCH_SKELETON_H
#define YOLO_BATCH_SKELETON_H
...
private:
    ...
    std::string yolofilePath = "yolov8m-pose_512_1024.torchscript";//RTX5000ada:yolov8m-pose_320_640_ada.torchscript, RTX A5000 yolov8m-pose_320_640.torchscript
    //std::string yolofilePath = "yolov8x-pose_640_1280.torchscript";
    ...
    const float ConfThreshold_joint = 0.45;//definitely adopt
    ...
    void initializeDevice()
    {
        ...
        if (torch::cuda::is_available())
        {
            ...
            device = new torch::Device(torch::kCUDA, 1);//choose RTX 5000
...
public:
    ...
    void matching(std::vector<std::vector<double>>& candidates, std::vector<std::vector<double>>& newData, std::vector<int>& idx_match, std::vector<int>& counter_notUpdate, std::vector<int>& index_delete_send);
