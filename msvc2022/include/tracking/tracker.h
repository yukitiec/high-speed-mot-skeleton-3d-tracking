...
private:
    ...
    const int MATCHINGMETHOD = cv::TM_SQDIFF_NORMED; // //cv::TM_SQDIFF_NORMED -> unique background, cv::TM_CCOEFF_NORMED :: ���֌W��, cv::TM_CCORR_NORMED -> patterned background // TM_SQDIFF_NORMED is good for small template
